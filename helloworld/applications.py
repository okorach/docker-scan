...
from mytool.util import types, cache

from mytool import exceptions, projects, branches, app_branches
from mytool.permissions import permissions, application_permissions
import mytool.sqobject as sq
import mytool.aggregations as aggr
...
class Application(aggr.Aggregation):
    ...
    def get_filtered_branches(self, filters: dict[str, str]) -> Union[None, dict[str, object]]:
        ...
        from mytool.app_branches import ApplicationBranch

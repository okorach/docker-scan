...
from mytool.util import types
import mytool.util.constants as c
import mytool.logging as log
import mytool.sqobject as sq
import mytool.platform as pf

from mytool import settings, tasks, measures, utilities, rules

import mytool.audit.problem as pb
...
class Component(sq.SqObject):
    ...
    def get_issues(self, filters: types.ApiParams = None) -> dict[str, object]:
        ...
        from mytool.issues import search_all
    ...
    def count_specific_rules_issues(self, ruleset: list[str], filters: types.ApiParams = None) -> dict[str, int]:
        ...
        from mytool.issues import count_by_rule
    ...
    def get_hotspots(self, filters: types.ApiParams = None) -> dict[str, object]:
        ...
        from mytool.hotspots import component_filter, search
    ...
    def migration_export(self, export_settings: types.ConfigSettings) -> dict[str, any]:
        from mytool.issues import count as issue_count
        from mytool.hotspots import count as hotspot_count
    ...
    def api_params(self, op: str = c.LIST) -> types.ApiParams:
        from mytool.issues import component_filter

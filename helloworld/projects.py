...
import mytool.logging as log
import mytool.platform as pf

from mytool.util import types, cache, constants as c
from mytool import exceptions, errcodes
from mytool import sqobject, components, qualitygates, qualityprofiles, tasks, settings, webhooks, devops
import mytool.permissions.permissions as perms
from mytool import pull_requests, branches
import mytool.utilities as util
import mytool.permissions.project_permissions as pperms

from mytool.audit import severities
from mytool.audit.rules import get_rule, RuleId
from mytool.audit.problem import Problem
...
class Project(components.Component):
    ...
    def get_findings(self, branch: Optional[str] = None, pr: Optional[str] = None) -> dict[str, object]:
        ...
        """
        from mytool import issues, hotspots
